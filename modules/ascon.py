...
if __name__ == "__main__":
    # quick self-check: same input -> same output, different input -> different output
    h1 = ascon_xof(b"hello world", 32)
    h2 = ascon_xof(b"hello world", 32)
    h3 = ascon_xof(b"hello world!", 32)
    assert h1 == h2
    assert h1 != h3
    print("ascon_xof self-consistency check passed.")
    print("XOF(32):", h1.hex())
    print("XOF(64):", ascon_xof(b"hello world", 64).hex())
