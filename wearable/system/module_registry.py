...
REGISTRY = {
    ...
    "camera": {
        "kind": MOD_ACTION,
        "path": "wearable.peripherals.camera",
        "class": "CameraManager",
    ...
    "lora": {
        "kind": MOD_SERVICE,
        "path": "wearable.communications.lora_radio",
        "class": "LoRaRadio",
        "aliases": {"lora", "radio"},
        "switchable": True,
        "payload_type": None,
    ...
    "bluetooth": {
        "kind": MOD_SERVICE,
        "path": "wearable.peripherals.bluetooth",
